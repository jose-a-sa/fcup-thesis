...
\hypersetup{pdfpagemode={UseOutlines},bookmarks=true,bookmarksopen=true,
   ...
   colorlinks=false,citecolor=green,urlcolor=blue,linkcolor=red,
   pdfstartview={FitV},unicode}
...
\newcommand*{\coosupervisor}[2][]{
	\def\coosupnamenolink{#2}
	\ifthenelse{ \equal{#1}{} }{
		\def\coosupname{#2} }{
		\def\coosupname{\texorpdfstring{\href{#1}{#2}}{#2}}
	}
}
...
\newcommand*{\coosupervisoraffiliation}[2][]{
	\def\coosupaffilnolink{#2}
	\ifthenelse{ \equal{#1}{} }{
		\def\coosupaffil{#2} }{
		\def\coosupaffil{\texorpdfstring{\href{#1}{#2}}{#2}}
	}
}
\newif\ifotheraffiliation
\newcommand*{\otheraffiliation}[4][]{
	...
	\otheraffiliationtrue
}
\newif\ifextraaffiliation
...
\newcommand*{\coosupervisorposition}[1]{
	\def\coosuppos{#1}
}
...
\begin{minipage}[b][297mm][t]{125mm}
	...
	\parbox[b][200mm][c]{125mm}{
		...
		{\small~\\}
		\fi
		\ifdefined\coosupaffilnolink
		{\large \bfseries Coorientador \\}
		{\small \coosupname\ifdefined\coosuppos ,~\coosuppos\fi\\\coosupaffil \\}
		{\small~\\}
		\fi
	}
	\vspace{5mm}
...
\begin{minipage}[b][297mm][b]{\sidew}
	\setstretch{1.0}
	\includegraphics[width=52mm]{fcup}\\[2mm]
    ...
    \put(0,0){\parbox[b][297mm][c]{210mm}
	{
		...
		\parbox[b][117mm][t]{117mm}
		{
			...
			\parbox[b][35mm][b]{90mm}{
				...
				{\smaller \parbox{65mm}{\centering\degree} \\[1mm] 
				 \parbox{60mm}{\centering\deptnamenolink} \\[2mm] }
				{\large \the\year \\[1mm] }
			}
		}
	}}% 
			...
			\begin{minipage}[b][297mm][t]{125mm}
				...
				\parbox[b][180mm][c]{125mm}{
					...
					{\large Dissertação de \ttype~apresentada à \\
						Faculdade de Ciências da Universidade do Porto\ifotheraffiliation
							\ifextraaffiliation , \otheraffilnolink~e \extraaffilnolink
							\else ~e \otheraffilnolink \fi
						\else	 
							\ifextraaffiliation ~e \extraaffilnolink \fi 
						\fi~em \\
					\scifield \\}
					{\LargeA \the\year \\}
				}
...
\newcommand\Spine{
    \put(-1,0){\parbox[b][297mm][t]{\coverwidth}{% SPINE BEGINS HERE
		...
		\begin{minipage}[c][297mm][t]{\spinew}
			...
			\setstretch{1.0} 
			\small FCUP \\
			\ifotheraffiliation \otherabbrev \\ \fi
			\ifextraaffiliation \extraabbrev \\ \fi
			\the\year
