...
\begin{minipage}[b][297mm][b]{54.3mm}
	...
	\includegraphics[width=52mm]{logo3}

	\vspace{3mm}
	\includegraphics[width=52mm]{logo2}
		...
		\raggedleft\parbox[b][\coverheight]{210mm}{% FRONT STARTS HERE
			...
			\begin{minipage}[b][\coverheight][t]{125mm}
				\parbox[t]{125mm}{
					...
					\vspace{3mm}
					\includegraphics[width=52mm]{logo2}\hspace{19mm}

					\vspace{3mm}
					\includegraphics[width=52mm]{logo3}\hspace{19mm}

					% ADD EXTRA LOGO FUNCTIONALITY
				}
				\vfill
				\parbox[t][170mm][t]{125mm}{
					\raggedright
					\setstretch{2.6}
					{\HUGE \bfseries \fronttitle} \\
					\setstretch{1.2} {\large~\\}
